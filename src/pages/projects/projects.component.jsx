...
const ProjectsPage = props => (
    <div className='projects_wrapper'>
        <div className='projects_container'>
            ...
            <a href='https://crwnclothing-live-shop-popup.herokuapp.com/' target='_blank' rel="noopener noreferrer"git stat><img className='crown-clothing-app' src='/Crown-Clothing.png' alt='projectimage'/></a>
        </div>
    </div>
); 
